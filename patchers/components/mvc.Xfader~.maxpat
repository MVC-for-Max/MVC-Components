...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 80.0, 57.0, 30.0, 30.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 269.0, 101.0, 39.0, 22.0 ],
									"text" : "$3 30"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "multichannelsignal" ],
									"patching_rect" : [ 214.0, 261.0, 38.0, 22.0 ],
									"text" : "mc.*~"
								}
...
,
									"patching_rect" : [ 275.0, 320.0, 70.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"fontname" : "Lato",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 240.0, 225.0, 105.0, 22.0 ],
									"text" : "cycle~ #0pan.aif"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 103.0, 225.0, 105.0, 22.0 ],
									"text" : "cycle~ #0pan.aif"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 269.0, 193.0, 43.0, 22.0 ],
									"text" : "+~ 0.5"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 269.0, 158.0, 35.0, 22.0 ],
									"text" : "line~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 269.0, 132.0, 58.0, 22.0 ],
									"text" : "pack 0. 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "multichannelsignal" ],
									"patching_rect" : [ 77.0, 65.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "multichannelsignal" ],
									"patching_rect" : [ 214.0, 65.0, 30.0, 30.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 278.5, 191.0, 335.5, 191.0 ],
									"order" : 0,
									"source" : [ "obj-58", 0 ]
								}
...
,
					"patching_rect" : [ 35.0, 190.0, 109.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 285.0, 74.0, 115.0, 22.0 ],
