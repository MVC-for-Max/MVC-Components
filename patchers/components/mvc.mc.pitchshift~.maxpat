...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 163.0, 268.193507598784208, 201.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "mc.pitchshift~ @busymapname #0.busymap"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 108.0, 102.0, 492.0, 35.0 ],
					"text" : "mvc.model #0 #1 #2 @type mvc.mc.pitchshift~ @autoinit 1",
					"varname" : "mvc.model"
				}
