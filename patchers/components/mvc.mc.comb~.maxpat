...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 258.0, 312.0, 57.0, 22.0 ],
					"text" : "chans $1"
				}
...
,
									"patching_rect" : [ 146.5, 105.0, 76.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "bang" ],
									"patching_rect" : [ 50.0, 78.0, 115.5, 22.0 ],
									"text" : "t i b"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 203.5, 164.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 146.5, 164.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 248.0, 164.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 177.0, 312.0, 69.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 177.0, 205.0, 186.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 147.0, 467.0, 147.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 147.0, 438.0, 270.0, 22.0 ],
					"text" : "mc.comb~ 100 @busymapname #0.busymap"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "" ],
					"patching_rect" : [ 177.0, 168.0, 334.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "mvc.model #0 #1 #2 @type mvc.mc.comb~ @autoinit 1",
					"varname" : "mvc.model"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 260.300000000000011, 427.0, 219.25, 427.0 ],
					"source" : [ "obj-12", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 186.5, 425.0, 156.5, 425.0 ],
					"source" : [ "obj-29", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 236.5, 347.0, 503.5, 347.0 ],
					"source" : [ "obj-29", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-55", 1 ],
					"midpoints" : [ 267.5, 342.5, 156.5, 342.5 ],
					"order" : 0,
					"source" : [ "obj-7", 0 ]
				}
