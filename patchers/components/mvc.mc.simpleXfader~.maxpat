...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 125.0, 183.0, 95.0, 22.0 ],
					"text" : "zmap -1. 1. 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 125.0, 263.0, 33.0, 22.0 ],
					"text" : "* 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 125.0, 105.0, 95.0, 22.0 ],
					"text" : "zmap 0. 1. -1. 1."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 125.0, 133.0, 212.0, 41.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 1.0, 120.0, 22.0 ],
					"signed" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "" ],
					"patching_rect" : [ 125.0, 216.0, 289.0, 35.0 ],
					"text" : "mvc.parameter #1 #2 @type decimal @range 0. 1. @clip both @description \"Cross fader\" @default 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 80.0, 101.0, 30.0, 30.0 ]
				}
...
,
					"patching_rect" : [ 35.0, 287.0, 109.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 35.0, 101.0, 30.0, 30.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 134.5, 257.0, 115.5, 257.0, 115.5, 94.0, 134.5, 94.0 ],
					"order" : 1,
					"source" : [ "obj-6", 0 ]
				}
