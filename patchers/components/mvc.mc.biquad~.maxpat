...
,
					"patching_rect" : [ 332.0, 295.0, 76.0, 22.0 ],
...
,
					"patching_rect" : [ 96.5, 166.0, 411.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 96.5, 196.0, 58.0, 35.0 ],
					"text" : "prepend chans"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 113.0, 355.0, 270.0, 37.0 ],
...
,
					"patching_rect" : [ 107.0, 280.0, 63.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 521.0, 441.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 28.0, 411.0, 380.0, 22.0 ],
					"text" : "mc.*~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 107.0, 247.0, 401.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 28.0, 362.0, 80.0, 22.0 ],
					"text" : "mc.cascade~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "" ],
					"patching_rect" : [ 96.5, 122.0, 333.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 28.0, 441.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "mvc.model #0 #1 #2 @type mvc.mc.biquad~",
					"varname" : "mvc.model"
				}
