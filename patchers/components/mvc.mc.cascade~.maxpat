...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 112.5, 210.0, 96.0, 22.0 ],
									"text" : "mvc.DSPrefresh"
								}
...
,
									"patching_rect" : [ 112.5, 238.0, 61.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 61.0, 266.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 113.0, 266.0, 30.0, 30.0 ]
								}
...
,
									"text" : "dict #0.channel.attr @legacy 1 @quiet 1"
								}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 117.0, 124.0, 150.0, 60.0 ],
									"text" : "mute the audio when changing channel- or filter-count, to avoid audio glitches."
								}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 48.0, 353.0, 50.0, 22.0 ],
					"text" : "mc.*~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 163.0, 267.0, 347.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 96.0, 270.0, 58.0, 35.0 ],
					"text" : "prepend chans"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 678.0, 489.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "" ],
					"patching_rect" : [ 96.0, 172.0, 359.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 96.0, 105.0, 601.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 506.0, 30.0, 30.0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.59163361787796, 0.0, 0.552864074707031, 1.0 ],
					"destination" : [ "obj-11", 0 ],
					"order" : 2,
					"source" : [ "obj-22", 0 ]
				}
