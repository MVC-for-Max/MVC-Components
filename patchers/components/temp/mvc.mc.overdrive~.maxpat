...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 208.0, 450.0, 150.0, 87.0 ],
					"text" : "no busymap as there seeems to be a conflict with updating channel values after changing channelcount (reported to C74)"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 47.0, 345.0, 82.0, 22.0 ],
					"text" : "mc.separate~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 144.0, 280.193507598784208, 200.0, 22.0 ],
...
,
					"patching_rect" : [ 144.0, 303.456170212765983, 87.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 144.0, 256.930844984802434, 126.25, 22.0 ],
					"text" : "t i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 251.25, 308.0, 57.0, 22.0 ],
					"text" : "chans $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 592.0, 476.5, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "multichannelsignal", "multichannelsignal" ],
					"patching_rect" : [ 28.0, 380.0, 135.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 172.5, 349.0, 348.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 144.0, 421.0, 212.0, 22.0 ],
					"text" : "mc.overdrive~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 28.0, 476.5, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "mvc.model #0 #1 #2 @type mc.overdrive @autoinit 1",
					"varname" : "mvc.model"
				}
