...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 541.0, 20.0, 326.0, 74.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 592.0, 225.0, 35.0, 22.0 ],
									"text" : "1000"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 634.5, 279.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 592.0, 253.0, 104.0, 22.0 ],
...
,
									"patching_rect" : [ 402.0, 473.5, 397.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 402.0, 445.5, 100.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 400.0, 580.5, 215.0, 16.0 ],
									"setminmax" : [ -24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "int", "" ],
									"patching_rect" : [ 400.0, 598.5, 405.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 400.0, 514.5, 215.0, 16.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "int", "" ],
									"patching_rect" : [ 400.0, 534.5, 435.0, 22.0 ],
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 972.0, 873.0, 50.0, 49.0 ],
													"text" : "recall myPreset"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 807.0, 654.0, 201.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 779.0, 857.0, 50.0, 35.0 ],
													"text" : "myPreset"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 895.0, 874.0, 50.0, 35.0 ],
													"text" : "mySubmodel"
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 913.0, 944.0, 65.0, 22.0 ],
													"saved_object_attributes" : 													{
														"embed" : 0,
														"legacy" : 0,
														"parameter_enable" : 0,
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 789.0, 623.0, 128.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 918.0, 813.0, 55.0, 22.0 ],
													"text" : "zl.slice 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 789.0, 690.0, 73.0, 22.0 ],
													"text" : "route preset"
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-54", 0 ],
													"midpoints" : [ 963.5, 845.0, 1034.0, 845.0, 1034.0, 758.0, 798.5, 758.0 ],
													"order" : 1,
													"source" : [ "obj-56", 1 ]
												}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 302.0, 385.0, 178.0, 22.0 ],
									"text" : "param channel.{2|4}/filter.*/Q $1"
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 409.5, 630.0, 391.5, 630.0, 391.5, 569.225911562671172, 409.5, 569.225911562671172 ],
									"source" : [ "obj-13", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-9", 0 ],
									"midpoints" : [ 409.5, 566.5, 391.5, 566.5, 391.5, 503.5, 409.5, 503.5 ],
									"source" : [ "obj-17", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 411.5, 498.892615469724319, 391.5, 498.892615469724319, 391.5, 435.61392712775546, 411.5, 435.61392712775546 ],
									"source" : [ "obj-38", 0 ]
								}
