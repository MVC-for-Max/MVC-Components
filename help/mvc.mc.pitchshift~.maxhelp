...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 285.0, 175.0, 143.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 38.5, 195.0, 181.0, 22.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 120.0, 415.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 85.0, 412.0, 29.5, 22.0 ],
									"text" : "*~"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 57.0, 412.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 22.0, 409.0, 29.5, 22.0 ],
									"text" : "*~"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 22.0, 441.0, 70.0, 22.0 ],
									"text" : "mc.pack~ 2"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 22.0, 379.0, 84.0, 22.0 ],
									"text" : "mc.unpack~ 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "multichannelsignal" ],
									"patching_rect" : [ 21.5, 466.0, 140.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 718.0, 108.5, 30.0, 22.0 ],
									"text" : "GUI"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 481.0, 135.5, 256.0, 29.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "int", "" ],
									"patching_rect" : [ 340.5, 375.0, 381.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 21.5, 490.0, 45.0, 45.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "multichannelsignal", "" ],
									"patching_rect" : [ 21.5, 283.5, 312.0, 22.0 ],
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-51::obj-3::obj-5::obj-25::obj-61::obj-20.1::obj-5::obj-12::obj-8::obj-7" : [ "live.toggle[1]", "live.toggle", 0 ],
